...
def start(client, message):
    ...
    message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton('𝐒𝐔𝐏𝐏𝐎𝐑𝐓 👬', url='https://t.me/TamilKingdom143'),
                    InlineKeyboardButton('𝐀𝐃𝐃 𝐌𝐄 🤗', url='https://t.me/Chatgpt3442_bot?startgroup=true')
                ]
            ]
        )
    )
...
def a(client, message):
    ...
    try:
        ...
        m.edit('❌ 𝐄𝐫𝐫𝐨𝐫\n\n Report This Erorr To Fix @TamilKingdom143 ❤️')
        print(e)
    try:
